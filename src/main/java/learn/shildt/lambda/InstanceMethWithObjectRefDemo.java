...
class HighTemp {
    ...
    // Возвратить логическое значение true, если вызывающий объект типа HighTemp имеет температуру ниже,
    // чем у объекта ht2
...
public class InstanceMethWithObjectRefDemo {
    ...
    // функционального интерфейса MyFunc2
    ...
    public static void main(String[] args) {
        ...
        HighTemp[] weekDaysHighs2 = {new HighTemp(32), new HighTemp(12), new HighTemp(24), new HighTemp(19),
        ...
        System.out.println("Дней, когда максимальная температура была 12 градусов: " + count);

        count = counter(weekDaysHighs, HighTemp::lessThanTemp, new HighTemp(89));
        System.out.println("Дней, когда максимальная температура была меньше 89 градусов: " + count);
