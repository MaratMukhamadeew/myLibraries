...
public class TicTacToeApplet extends Applet implements ActionListener {
     ...
     * Он проверяет каждый ряд, кнопку и диагональ, чтобы найти три клетки с одинаковыми надписями (не пустыми)
    ...
    /**
     * Этот метод проверяет каждый ряд, колонку и диагональ, чтобы узнать, есть ли в ней
